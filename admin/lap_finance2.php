...
$no=1;
$query=mysql_query("select * from finance where tgl between '$p1' and '$p2' order by tgl asc");
...
$pdf->SetFont('Arial','B',10);
$jml=mysql_query("select sum(debit) as jd, sum(kredit) as jk from finance where tgl between '$p1' and '$p2'");
