...
$pdf->Cell(0,0.7,'LAPORAN PENGELUARAN',0,1,'C');
...
$no=1;
$query=mysql_query("select * from finance where akun = 000221 and period = $per order by tgl asc");
...
$pdf->SetFont('Arial','B',8);
$jml=mysql_query("select sum(debit) as jd, sum(kredit) as jk from finance where akun = 000221 and period = $per");
...
$pdf->Cell(2.5, 0.8, 'Kredt', 1, 1, 'C');
$no=1;
$query=mysql_query("select * from finance where akun = 000222 and period = $per order by tgl asc");
while($lihat=mysql_fetch_array($query)){
	$fak=$lihat['no'];
	$pdf->SetFont('Arial','',8);
	$fak=sprintf('%04d' , $fak);
...
$pdf->SetFont('Arial','B',8);
$jml=mysql_query("select sum(debit) as jd, sum(kredit) as jk from finance where akun = 000222 and period = $per ");
while($see=mysql_fetch_array($jml)){
	$jum=$see['jk']-$see['jd'];
	$pdf->Cell(22.5, 0.8, 'Total', 1, 0,'C');
	$pdf->Cell(5, 0.8, number_format($jum,0,'',','), 1, 0,'R');
...
$pdf->Cell(2.5, 0.8, 'Kredt', 1, 1, 'C');
$no=1;
$query=mysql_query("select * from finance where akun = 000223 and period = $per order by tgl asc");
while($lihat=mysql_fetch_array($query)){
	$fak=$lihat['no'];
	$pdf->SetFont('Arial','',8);
	$fak=sprintf('%04d' , $fak);
...
$pdf->SetFont('Arial','B',8);
$jml=mysql_query("select sum(debit) as jd, sum(kredit) as jk from finance where akun = 000223 and period = $per ");
while($see=mysql_fetch_array($jml)){
	$jum=$see['jk']-$see['jd'];
	$pdf->Cell(22.5, 0.8, 'Total', 1, 0,'C');
	$pdf->Cell(5, 0.8, number_format($jum,0,'',','), 1, 0,'R');
...
$pdf->Cell(2.5, 0.8, 'Kredt', 1, 1, 'C');
$no=1;
$query=mysql_query("select * from finance where akun = 000224 and period = $per order by tgl asc");
while($lihat=mysql_fetch_array($query)){
	$fak=$lihat['no'];
	$pdf->SetFont('Arial','',8);
	$fak=sprintf('%04d' , $fak);
...
$pdf->SetFont('Arial','B',8);
$jml=mysql_query("select sum(debit) as jd, sum(kredit) as jk from finance where akun = 000224 and period = $per ");
while($see=mysql_fetch_array($jml)){
	$jum=$see['jk']-$see['jd'];
	$pdf->Cell(22.5, 0.8, 'Total', 1, 0,'C');
	$pdf->Cell(5, 0.8, number_format($jum,0,'',','), 1, 0,'R');
...
$pdf->Cell(2.5, 0.8, 'Kredt', 1, 1, 'C');
$no=1;
$query=mysql_query("select * from finance where akun = 000225 and period = $per order by tgl asc");
while($lihat=mysql_fetch_array($query)){
	$fak=$lihat['no'];
	$pdf->SetFont('Arial','',8);
	$fak=sprintf('%04d' , $fak);
...
$pdf->SetFont('Arial','B',8);
$jml=mysql_query("select sum(debit) as jd, sum(kredit) as jk from finance where akun = 000225 and period = $per ");
while($see=mysql_fetch_array($jml)){
	$jum=$see['jk']-$see['jd'];
	$pdf->Cell(22.5, 0.8, 'Total', 1, 0,'C');
	$pdf->Cell(5, 0.8, number_format($jum,0,'',','), 1, 0,'R');
...
$pdf->Cell(2.5, 0.8, 'Kredt', 1, 1, 'C');
$no=1;
$query=mysql_query("select * from finance where akun = 000226 and period = $per order by tgl asc");
while($lihat=mysql_fetch_array($query)){
	$fak=$lihat['no'];
	$pdf->SetFont('Arial','',8);
	$fak=sprintf('%04d' , $fak);
...
$pdf->SetFont('Arial','B',8);
$jml=mysql_query("select sum(debit) as jd, sum(kredit) as jk from finance where akun = 000226 and period = $per ");
while($see=mysql_fetch_array($jml)){
	$jum=$see['jk']-$see['jd'];
	$pdf->Cell(22.5, 0.8, 'Total', 1, 0,'C');
	$pdf->Cell(5, 0.8, number_format($jum,0,'',','), 1, 0,'R');
...
$pdf->Cell(2.5, 0.8, 'Kredt', 1, 1, 'C');
$no=1;
$query=mysql_query("select * from finance where akun = 000228 and period = $per order by tgl asc");
while($lihat=mysql_fetch_array($query)){
	$fak=$lihat['no'];
	$pdf->SetFont('Arial','',8);
	$fak=sprintf('%04d' , $fak);
...
$pdf->SetFont('Arial','B',8);
$jml=mysql_query("select sum(debit) as jd, sum(kredit) as jk from finance where akun = 000228 and period = $per ");
while($see=mysql_fetch_array($jml)){
	$jum=$see['jk']-$see['jd'];
	$pdf->Cell(22.5, 0.8, 'Total', 1, 0,'C');
	$pdf->Cell(5, 0.8, number_format($jum,0,'',','), 1, 0,'R');
